package com.tempemusic.music.discord
...
import com.tempemusic.music.BuildConfig
...
object DiscordRpcManager {
    ...
    fun init(context: Context) {
        ...
        Timber.i("init: loading native library 'tempemusic_discord'")
        try {
            System.loadLibrary("tempemusic_discord")
