...
val baseApplicationId = "com.tempemusic.music"
val applicationIdOverride = System.getenv("TEMPEMUSIC_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("TEMPEMUSIC_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("TEMPEMUSIC_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("TEMPEMUSIC_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("TEMPEMUSIC_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("TEMPEMUSIC_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    namespace = "com.tempemusic.music"
    compileSdk = 37
    ...
    defaultConfig {
        ...
        versionCode = 148
        versionName = "13.5.0"
        resValue("string", "app_name", appNameOverride ?: "TempeMusic")
    ...
    buildTypes {
        ...
        debug {
            ...
            if (appNameOverride == null) {
                resValue("string", "app_name", "TempeMusic Debug")
            }
            signingConfig =
...
val protoDir = rootProject.file("tempeproto")
